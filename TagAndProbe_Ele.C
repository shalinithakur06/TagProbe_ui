...
for(int i=0; i<systematicVar.size();i++)
{
   ...
   double pt_bins_Ele27[16] = {0,10,20,24,25,26,27,28,29,30,35,50,60,100,200,1000};
...
// HLT Ele27
   ...
   TH2F *h_Ele27_pt_eta_total = new TH2F("Ele27_pt_eta_total","Ele27_pt_eta",10,eta_bins,15,pt_bins_Ele27);
   ...
   TH2F *h_Ele27_pt_eta_pass = new TH2F("Ele27_pt_eta_pass","Ele27_pt_eta",10,eta_bins,15,pt_bins_Ele27);
...
// HLT Ele23_Ele12 Ele12 leg
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      bool probe_EleId = passMyId(second, ele_etaSC->at(second));
...
bool TagAndProbe::passMyId(int i, double eta)
{
...
double dEtain = ele_dEtaIn->at(i);
double dEtainseed = ele_dEtaInSeed->at(i);
double ieminusip = ele_iEminusiP->at(i);
double ninnerlosthits = ele_nInnerLostHits->at(i);
double isecaldriven = ele_isEcalDriven->at(i);
double e5x5 = ele_energy5x5->at(i);
double e2x5 = ele_energy2x5->at(i);
double e1x5 = ele_energy1x5->at(i);
double eRho = ele_eleRho->at(i);
double eTrkpt = ele_eleTrkPt->at(i);
double GsfeleEmHadD1IsoRhocut = ele_GsfEleEmHadD1IsoRhoCut->at(i);
double isee = ele_isEE->at(i);
double iseb = ele_isEB->at(i);
