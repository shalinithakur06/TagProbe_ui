...
// Mon May 11 23:24:40 2020 by ROOT version 5.34/36
// from TTree EventTree/Event data
// found on file: ExcitedEle_ntuple_9.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<double>  *ele_iEminusiP;
   vector<double>  *ele_nInnerHits;
   vector<double>  *ele_nInnerLostHits;
   vector<double>  *ele_isPassConVeto;
   vector<double>  *ele_isEcalDriven;
   vector<double>  *ele_energy5x5;
   vector<double>  *ele_energy2x5;
   vector<double>  *ele_energy1x5;
   vector<double>  *ele_eleRho;
   vector<double>  *ele_eleTrkPt;
   vector<double>  *ele_GsfEleEmHadD1IsoRhoCut;
   vector<double>  *ele_relCombPFIsoEA;
   vector<int>     *ele_isEE;
   vector<int>     *ele_isEB;
   ...
   TBranch        *b_ele_iEminusiP;   //!
   TBranch        *b_ele_nInnerHits;   //!
   TBranch        *b_ele_nInnerLostHits;   //!
   TBranch        *b_ele_isPassConVeto;   //!
   TBranch        *b_ele_isEcalDriven;   //!
   TBranch        *b_ele_energy5x5;   //!
   TBranch        *b_ele_energy2x5;   //!
   TBranch        *b_ele_energy1x5;   //!
   TBranch        *b_ele_eleRho;   //!
   TBranch        *b_ele_eleTrkPt;   //!
   TBranch        *b_ele_GsfEleEmHadD1IsoRhoCut;   //!
   TBranch        *b_ele_relCombPFIsoEA;   //!
   TBranch        *b_ele_isEE;   //!
   TBranch        *b_ele_isEB;   //!
   ...
   bool  passMyId(int i, double eta);
};
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ExcitedEle_ntuple_9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ExcitedEle_ntuple_9.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ExcitedEle_ntuple_9.root:/ntupler");
...
void TagAndProbe::Init(TTree *tree)
{
   ...
   ele_eleRho = 0;
   ele_eleTrkPt = 0;
   ele_GsfEleEmHadD1IsoRhoCut = 0;
   ele_relCombPFIsoEA = 0;
   ele_isEE = 0;
   ele_isEB = 0;
   passEleIdLoose = 0;
   passEleIdMedium = 0;
   ...
   fChain->SetBranchAddress("ele_dEtaInSeed", &ele_dEtaInSeed, &b_ele_dEtaInSeed);
   fChain->SetBranchAddress("ele_iEminusiP", &ele_iEminusiP, &b_ele_iEminusiP);
   fChain->SetBranchAddress("ele_nInnerHits", &ele_nInnerHits, &b_ele_nInnerHits);
   fChain->SetBranchAddress("ele_nInnerLostHits", &ele_nInnerLostHits, &b_ele_nInnerLostHits);
   fChain->SetBranchAddress("ele_isPassConVeto", &ele_isPassConVeto, &b_ele_isPassConVeto);
   fChain->SetBranchAddress("ele_isEcalDriven", &ele_isEcalDriven, &b_ele_isEcalDriven);
   fChain->SetBranchAddress("ele_energy5x5", &ele_energy5x5, &b_ele_energy5x5);
   fChain->SetBranchAddress("ele_energy2x5", &ele_energy2x5, &b_ele_energy2x5);
   fChain->SetBranchAddress("ele_energy1x5", &ele_energy1x5, &b_ele_energy1x5);
   fChain->SetBranchAddress("ele_eleRho", &ele_eleRho, &b_ele_eleRho);
   fChain->SetBranchAddress("ele_eleTrkPt", &ele_eleTrkPt, &b_ele_eleTrkPt);
   fChain->SetBranchAddress("ele_GsfEleEmHadD1IsoRhoCut", &ele_GsfEleEmHadD1IsoRhoCut, &b_ele_GsfEleEmHadD1IsoRhoCut);
   fChain->SetBranchAddress("ele_relCombPFIsoEA", &ele_relCombPFIsoEA, &b_ele_relCombPFIsoEA);
